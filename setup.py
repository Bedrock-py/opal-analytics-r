"""Pip install script for bedrock.analytics.r.*
"""
...
def opalRegistration():
    ...
    success = manage_opals("add","analytics","opals.r.R.R")
    if (success == False):
        success = manage_opals("reload","analytics","opals.r.R.R")
        if (success == False):
            raise
...
setup(
    ...
    description='Integration with R',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.gatech.edu/Bedrock/opal-analytics-r',
